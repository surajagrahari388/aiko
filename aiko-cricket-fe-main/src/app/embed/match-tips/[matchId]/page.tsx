...
import EmbedMatchTipsClient from "./embed-match-tips-client";

export const dynamic = "force-dynamic";

interface EmbedMatchTipsPageProps {
  params: Promise<{ matchId: string }>;
  searchParams: Promise<EmbedSearchParams>;
}

export default async function EmbedMatchTipsPage({
  params,
  searchParams,
}: EmbedMatchTipsPageProps) {
